package com.oauth.applikation.config;

import com.oauth.applikation.config.oauth2.MongoDBApprovalStore;
import com.oauth.applikation.config.oauth2.MongoDBAuthorizationCodeServices;
import com.oauth.applikation.config.oauth2.MongoDBClientDetailsService;
import com.oauth.applikation.config.oauth2.MongoDBTokenStore;
import com.oauth.applikation.repository.*;
...
public class OAuth2ServerConfiguration {
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
            resources.resourceId("res_realylast").tokenStore(tokenStore);
        }
    }
